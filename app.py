...
def operation_result():
    ...
    if request.method == "POST" and calculator_form.validate():
        ...
        power = calculator.power_from_configuraton(charger_configuration)

        price = calculator.price_from_configuration(charger_configuration)

        cost = calculator.cost_calculation(initial_charge, final_charge, battery_capacity, price, is_peak, is_holiday)
